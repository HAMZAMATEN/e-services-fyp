...
import 'package:e_services_fyp/service_provider_pages/Orders/Screens/Direct/state.dart';
import 'package:e_services_fyp/utils/compnents/snackbar_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';

class DirectOrdersController extends GetxController {
  final state = DirectOrdersState();


  // final state = ScheduledState();
  final ref = FirebaseFirestore.instance.collection('bookedServices').where('pId', isEqualTo: SessionController().userId.toString()).snapshots();
